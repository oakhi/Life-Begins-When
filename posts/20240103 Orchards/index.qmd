...
His aunt Sister `M` was taking care her Mom. Once she dreamt that her ancestors came and asked their work to be done at a temple.

Now that area is part of the Payson Temple complex.

------------------------------------------------------------------------

After we were married, we would visit the same area to pick apples. [^1] There were simply too many apples that needed to be harvested.

[^1]: Sister K also remembers picking asparagus
...
Recently dreamed that I was visiting an orchard.
...
Dreams are one way to convey messages. If we are prepared and alert.
...
The alternate plan turns out to be better than the original

The plan by Heavenly Father is better than anything we can imagine.

Start out humble in Korea
